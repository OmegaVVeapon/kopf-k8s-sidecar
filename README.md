...
| NAMESPACE | No | `ALL` | The `Namespace`(s) from which resources will be watched.
For multiple namespaces, use a comma-separated string like "default,test".<br>If not set or set to `ALL`, it will watch all `Namespace`s. |
